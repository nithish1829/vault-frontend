...
import "./Calculator.css"; // ✅ move shake animation here

function Calculator() {
  const [shake, setShake] = useState(false);
  const [time, setTime] = useState(new Date().toLocaleTimeString());
  const [expression, setExpression] = useState(""); // ✅ FIXED MISSING STATE
  ...
  // 🔥 KEYBOARD INPUT (cleaned, single listener only)
  useEffect(() => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ color: "white", margin: 0 }}>🧮 Calculator</h2>
